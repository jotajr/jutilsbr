...
public class InscricaoEstadualMT extends InscricaoEstadualBase {
    private static final Integer[] MULTIPLICADOR = new Integer[]{Integer.valueOf(3), Integer.valueOf(2), Integer.valueOf(9), Integer.valueOf(8), Integer.valueOf(7), Integer.valueOf(6), Integer.valueOf(5), Integer.valueOf(4), Integer.valueOf(3), Integer.valueOf(2)};

    public InscricaoEstadualMT() {
    }
    ...
    public boolean validar(String numero) {
        ...
        if(ie.length() == 11) {
            ...
            valido = numeros[10].intValue() == digito;
        }
